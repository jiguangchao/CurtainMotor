...
//#define ID_ENTRY_BYTES                            (CURTAIN_LEARN_MAX*10+4)
#define ID_ENTRY_BYTES                            (ID_MAX_NR_ENTRIES*12+4)
...
typedef union
{
    struct
    {
        ...
        //ID_ENTRY_TYPE        entry[CURTAIN_LEARN_MAX];
    };
